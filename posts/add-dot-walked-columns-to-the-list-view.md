...
author: "James McGaha"
tags: ["tips & tricks","non-admin hacks","browser extension","list view tricks"]
---
...
2. If you have the [SuperNow browser extension](supernow-chrome-extension.html) installed, you will see an "unlock" icon next to the normal "personalize list" cog icon which will open up an enhanced personalize list modal that supports expanding reference fields.
